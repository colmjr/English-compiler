    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal modal-wide" onClick={e => e.stopPropagation()}>
        ...
        <div className="modal-body">
          ...
          <div className="form-group">
            ...
            <p className="form-hint">
              Your API key is stored locally and sent directly to {currentProvider.name}'s API.
            </p>
          </div>
          ...
          <details className="settings-advanced">
            ...
            <div className="settings-advanced-content">
              ...
              <div className="form-group">
                ...
                />
                <p className="form-hint">
                  Lower = more deterministic, Higher = more creative. Use 0 for consistent compilation.
                </p>
              </div>
        ...
        <div className="modal-footer">
          <button className="secondary" onClick={handleClear}>Reset</button>
